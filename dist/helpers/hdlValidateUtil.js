...
var _isIDCard1 = /^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$/; //身份证正则表达式(18位)
// eslint-disable-next-line no-unused-vars

var _isIDCard2 = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/; // 中华人民共和国身份证正则合并

var _isPrcIdCard = /(^\d{15}$)|(^\d{17}([0-9]|X)$)/; // mongodb ObjectId
...
var _isMobile = /^1[3|4|5|7|8]\d{9}$/; //var _isMobile = /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/;
...
module.exports.isValidHttpLink = function (dhost) {
  return /^http[s]?:\/\//.test(dhost);
};
//# sourceMappingURL=hdlValidateUtil.js.map
